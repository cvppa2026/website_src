...
function App() {
  ...
  return (
    <div className="min-h-screen bg-white text-slate-900 dark:bg-slate-950 dark:text-slate-100 font-sans transition-colors duration-300">
      <Navbar />
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 md:py-12 overflow-x-hidden">
        <div key={location.pathname} className="animate-fadeIn">
          <Routes location={location}>
            ...
            <Route path="/challenges" element={<MarkdownViewer filename="challenges.md" />} />
          </Routes>
        </div>
      </main>
    </div>
